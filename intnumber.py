...
def main() :
   global cip
   value = str(input("Please enter a positive integer < bilion: "))
   minor = False
   if value[0] =="-":
      value = value[1:]
      minor = True
   value = int(value)
   if value <= 99: cip = True
   if minor == True: print("minor " + intName(value))
   if minor == False: print(intName(value))
...
# last 999
   ...
   if part >= 20 :
      if cip == True: name = name + tensName(part)
      else: name = name + " " + tensName(part)
      part = part % 10
   elif part >= 10 :
      if cip == True: name = name + teenName(part)
      else: name = name + " " + teenName(part)
      part = 0

   if part > 0 :
      if cip == True:  name = name + digitName(part)
      else: name = name + " " + digitName(part)
